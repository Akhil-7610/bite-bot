...
export default function MealPlanDashboard() {
  ...
  return (
    ...
    <div className="min-h-screen  flex items-center justify-center p-4  ">
      <div className="w-full max-w-6xl flex flex-col md:flex-row  shadow-lg rounded-lg overflow-hidden border-2 border-emerald-300">
        {/* Left Panel: Form */}
        <div className="w-full md:w-1/3 lg:w-1/4 p-6 bg-emerald-500 text-black">
        ...
        <div className="w-full md:w-2/3 lg:w-3/4 p-6 text-white ">
              ...
              <div className="space-y-6">
                {daysOfWeek.map((day) => {
                  ...
                  return (
                    <div
                      key={day}
                      className="bg-black shadow-md rounded-lg p-4 border border-emerald-200"
                    >
